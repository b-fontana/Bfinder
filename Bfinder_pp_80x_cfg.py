...
"/store/mc/RunIISummer16DR80Premix/BsToJpsiPhi_BMuonFilter_SoftQCDnonD_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6_ext1-v2/100000/00063D8A-B0DA-E611-BDDD-001E674FBFC2.root"))
##"/store/mc/RunIISummer16DR80Premix/BuToJpsiK_BMuonFilter_SoftQCDnonD_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6_ext1-v1/100000/0077C695-E0DB-E611-BD65-008CFA110AEC.root"))
##Bd: "/store/mc/RunIISummer16DR80Premix/BdToJpsiKstar_BMuonFilter_SoftQCDnonD_TuneCUEP8M1_13TeV-pythia8-evtgen/AODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/100000/000BF1E2-C5E5-E611-A495-FA163EC8FC62.root"))

## Maximal Number of Events
process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(10) )

process.load('HLTrigger.HLTfilters.hltHighLevel_cfi')
process.hltHighLevel.HLTPaths = cms.vstring('HLT_DoubleMu4_JpsiTrk_Displaced_v*')
...
###new line (Bruno Galinhas said to add it)
...
##process.p = cms.Path(process.filter*process.analysis*process.content*process.hltanalysis)

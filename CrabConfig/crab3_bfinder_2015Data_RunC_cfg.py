...
config.General.requestName = 'Bfinder_2015Data_RunC_v2'
...
config.Data.inputDataset = '/Charmonium/Run2015C_25ns-16Dec2015-v1/AOD'
config.Data.splitting = 'LumiBased'     #'FileBased' for MC
config.Data.unitsPerJob = 5

# set here the path of a storage area you can write to
config.Data.outLFNDirBase = '/store/user/bfontana/Bfinder_Data2015_RunC_v2/'

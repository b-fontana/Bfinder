...
config.General.requestName = 'Bfinder_Bp_nocuts_MC2016'
...
config.Data.inputDataset ='/BuToJpsiK_SoftQCDnonD_TuneCUEP8M1_13TeV-pythia8-evtgen/RunIISpring16DR80-premix_withHLT_80X_mcRun2_asymptotic_v14-v1/AODSIM'
config.Data.splitting ='FileBased'     #'LumiBased' for data
config.Data.unitsPerJob = 2

# set here the path of a storage area you can write to
config.Data.outLFNDirBase = '/store/user/bfontana/Bfinder_Bp_MC2016_nocuts/'
